...
function Profile() {
  ...
  const getUser = async () => {
    try {
      ...
      // console.log("User data:", temp);  // Debug log to check the API response
      setFormDetails({
        ...temp,
        password: "",
        confpassword: "",
      ...
      // setFile(temp.profilepic);  // Adjust this if the field name is different
      // console.log(temp.profilepic);
      const baseURL = process.env.REACT_APP_SERVER_DOMAIN.replace('/api', '');
      setFile(`${baseURL}/${temp.profilepic}`);
          ...
          <div className="profile-container flex-center">
            ...
            <img
              ...
              onError={(e) => {
                ...
                setFile("https://via.placeholder.com/150");  // Fallback image
              }}
            />
